...
#region Members
  ...
  /// </summary>
  private void RunScript(string Material, int E, double PR, ref object Properties)
  {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////////////////
    if (string.IsNullOrEmpty(Material)){Material = "Steel";}
    B.Add(Material);
    B.Add("Elastic");
    if(E == 0){E = 210000;}
    if(PR == 0){PR = 0.3;}
    B.Add(string.Format("{0}, {1}", E, PR));
    B.Add("**");
  ...
  public override void InvokeRunScript(IGH_Component owner, object rhinoDocument, int iteration, List<object> inputs, IGH_DataAccess DA)
  {
    ...
    //4. Invoke RunScript
    RunScript(Material, E, PR, ref Properties);

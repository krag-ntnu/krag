...
#region Members
  ...
  {
        Point3d firstp = new Point3d(Cntr.X, Cntr.Y + W / 2, Cntr.Z - H / 2);
    Point3d secondp = new Point3d(Cntr.X, Cntr.Y + W / 2, Cntr.Z + H / 2);
    Point3d thirdp = new Point3d(Cntr.X, Cntr.Y - W / 2, Cntr.Z + H / 2);
    Point3d fourthp = new Point3d(Cntr.X, Cntr.Y - W / 2, Cntr.Z - H / 2);
    List<Point3d> ptslist = new List<Point3d>();
    ptslist.Add(fourthp); //reverse points to avoid negative volume
    ptslist.Add(thirdp);
    ptslist.Add(secondp);
    ptslist.Add(firstp);
    Pts = ptslist;
